...
class TrackFollowPointLocalAdapter extends TypeAdapter<TrackFollowPointLocal> {
  @override
  final int typeId = 2;

  @override
  TrackFollowPointLocal read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return TrackFollowPointLocal(
      id: fields[0] as String,
      followSessionId: fields[1] as String,
      latitude: fields[2] as double,
      longitude: fields[3] as double,
      timestamp: fields[4] as DateTime,
      isOffTrack: fields[5] == null ? false : fields[5] as bool,
      distanceFromTrack: fields[6] == null ? 0 : fields[6] as double,
      isSynced: fields[7] == null ? false : fields[7] as bool,
    );
  }

  @override
  void write(BinaryWriter writer, TrackFollowPointLocal obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.id)
      ..writeByte(1)
      ..write(obj.followSessionId)
      ..writeByte(2)
      ..write(obj.latitude)
      ..writeByte(3)
      ..write(obj.longitude)
      ...
      ..write(obj.timestamp)
      ..writeByte(5)
      ..write(obj.isOffTrack)
      ..writeByte(6)
      ..write(obj.distanceFromTrack)
      ..writeByte(7)
      ..write(obj.isSynced);
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TrackFollowPointLocalAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class TrackFollowSessionLocalAdapter
    extends TypeAdapter<TrackFollowSessionLocal> {
  @override
  final int typeId = 3;

  @override
  TrackFollowSessionLocal read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return TrackFollowSessionLocal(
      followSessionId: fields[0] as String,
      trackId: fields[1] as String,
      followId: fields[2] == null ? '' : fields[2] as String,
      ...
      totalDistance: fields[6] == null ? 0 : fields[6] as double,
      steps: fields[7] == null ? 0 : fields[7] as int,
      calories: fields[8] == null ? 0 : fields[8] as int,
      duration: fields[9] == null ? 0 : fields[9] as int,
    );
  ...
  @override
  void write(BinaryWriter writer, TrackFollowSessionLocal obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.followSessionId)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TrackFollowSessionLocalAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
