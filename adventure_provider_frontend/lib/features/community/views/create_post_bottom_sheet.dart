...
class _CreatePostBottomSheetState extends State<CreatePostBottomSheet> {
  ...
  String get _communityName => _c.selectedCommunity.value?.name ?? 'Community';
  ...
  Future<void> _pickImages() async {
    ...
    final toAdd = picks.take(remaining).map((x) => File(x.path)).toList();
    _selectedImages.addAll(toAdd);
  }

  void _showTrackPicker() {
    final trackController = Get.find<TrackController>();
    // Ensure we have some data (best-effort, no hard dependency on a network call here).
    if (trackController.myTracks.isEmpty) {
      // If the project has a fetch method, it can be called from UI later.
    }
                  ...
                  child: Obx(() {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        final t = tracks[i];
                        final cover = ApiConfig.resolveMediaUrl(t.coverImage);
                        return ListTile(
                          leading: ClipRRect(
                              ...
                              return Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    ...
                                    final profile = ApiConfig.resolveMediaUrl(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => _selectedTrack.value = null,
                                    ),
                                  ],
                                ),
                              );
                                        ...
                                        children: [
                                          ...
                                          Positioned(
                                            ...
                                            child: GestureDetector(
                                              onTap: () => _selectedImages.removeAt(i),
                                              child: Container(
                                                width: 18,
                                                height: 18,
                                                decoration: BoxDecoration(
